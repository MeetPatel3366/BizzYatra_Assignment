...
<body class="flex w-full h-full flex-col items-center justify-center">
    ...
    if(isset($_POST['register']))
    {
        ...
        else
        {
            ...
            if(($password==$cpassword))
            {
                ...
                $message .= "http://localhost/bizzYatra/3chatapp/verify.php?code=$verificationCode";
    ...
    ?>
    <div class="flex gap-2 bg-indigo-600 mt-8 p-2">
    <div class="flex w-80 flex-col items-center p-7 border rounded-lg font-medium">
    ...
    <div class="rounded-lg ">
        <img class="rounded-lg" src="./img/register.gif" alt="register">
    </div>
    </div>
    <!-- <div>
    </div> -->
